...
export function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        'border-input bg-background text-foreground flex h-10 w-full items-center justify-between rounded-lg border px-3 py-2',
        'text-sm shadow-sm transition-[color,box-shadow,border-color]',
